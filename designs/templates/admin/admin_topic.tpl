    ...
    <div class="panel panel-default">
      <div class="panel-body">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="collapse {if $error Or $getTopicByID.id}in{/if}" id="collapseExample" style="margin-top: 10px;">
              {if $getTopicByID.id}
              <form class="form" role="form" action="{$admin_file}?task=topic&amp;action=edit&amp;id={$getTopicByID.id}" method="post">
                {else}
                <form class="form" role="form" action="{$admin_file}?task=topic&amp;action=add" method="post">
                  {/if}
                  <div class="form-group" style="margin-bottom:5px;">
