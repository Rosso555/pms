        ...
        <div class="row">
          <div class="col-md-6">
            <form class="form-inline" action="{$admin_file}?task=topic" method="post">
              ...
              {else}
              <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> {if $multiLang.button_save}{$multiLang.button_save}{else}No Translate(Key Lang: button_save){/if}</button>
              {/if}
            </form>
          </div>
          <div class="col-md-6">
