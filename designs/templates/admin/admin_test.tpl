...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    <div class="panel panel-default">
      <div class="panel-body">
        <form class="form-inline" role="form" action="{$admin_file}?task=test" method="GET" style="padding: 1px 0px 12px 1px;">
          ...
          <div class="form-group select2_search_inline" style="margin-bottom:5px;">
            <select class="form-control select2_search" name="catid" style="width:100%;">
            ...
            <tr>
              ...
              <td>
                ...
                <div class="modal fade" id="myModal_{$data.id}" role="dialog">
                  ...
                  <a href="{$admin_file}?task=test_question_hide&amp;tid={$data.id}" class="btn btn-warning btn-xs" data-toggle1="tooltip" data-placement="top" title="Setting Test Qustion Condition Hide/Show" style="margin-bottom: 3px;"><i class="fa fa-plus-circle" aria-hidden="true"></i></a>
                  <a href="{$admin_file}?task=section&amp;tid={$data.id}" class="btn btn-info btn-xs" data-toggle1="tooltip" data-placement="top" title="Add Section" style="margin-bottom: 3px;"><i class="fa fa-plus-circle" aria-hidden="true"></i></a>
