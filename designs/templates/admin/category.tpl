    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="collapse {if $error Or $getCategoryByID.id}in{/if}" id="collapseExample" style="margin-top: 10px;">
              {if $getCategoryByID.id}
              <form class="form" role="form" action="{$admin_file}?task=category&amp;action=edit&amp;id=$getCategoryByID.id" method="post">
                {else}
                <form class="form" role="form" action="{$admin_file}?task=category&amp;action=add" method="post">
                  {/if}
