...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    <div class="panel panel-default">
      <div class="panel-body">
        <form class="form-inline" role="form" action="{$admin_file}?task=test_patient" method="GET" style="padding: 1px 0px 12px 1px;">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  {if $getTestPat.id}
                    ...
                    <a href="{$admin_file}?task=test_patient" class="btn btn-danger" style="color: white;"><i class="fa fa-close"></i> {if $multiLang.button_cancel}{$multiLang.button_cancel}{else}No Translate(Key Lang: button_cancel){/if}</a>
                  {else}
      ...
      <table class="table table-striped">
        ...
        {foreach from = $testPatient item = data key=k}
          <tr>
            ...
            <td>
              <a {if $data.status eq 1}href="{$admin_file}?task=test_patient&amp;action=edit&amp;id={$data.id}"{/if} class="btn btn-success btn-xs" {if $data.status eq 2}disabled{/if} data-toggle1="tooltip" data-placement="top"
                ...
                <div class="modal-dialog">
                  ...
                  <div class="panel panel-primary modal-content">
                    ...
                    <div class="modal-footer">
                      <a href="{$admin_file}?task=test_patient&amp;action=delete&amp;id={$data.id}" class="btn btn-danger btn-md" style="color: white;"><i class="fa fa-trash-o"> {if $multiLang.button_delete}{$multiLang.button_delete}{else}No Translate(Key Lang: button_delete){/if}</i></a>
