  ...
  <div class="container">
    ...
    {else}
      <ul class="nav navbar-nav">
        ...
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"><i class="fa fa-user-circle-o fa-fw fa-lg" aria-hidden="true"></i> {if $multiLang.menu_staff}{$multiLang.menu_staff}{else}No Translate (Key Lang:menu_staff){/if} <span class="caret"></span></a>
          <ul class="dropdown-menu">
          {foreach from=$staffPermission item=v}
            {if $v.task_name eq 'staff_info'}<li><a href="{$admin_file}?task=staff_info"><i class="fa fa-users" aria-hidden="true"></i> {if $multiLang.menu_information}{$multiLang.menu_information}{else}No Translate (Key Lang:menu_information){/if}</a></li>{/if}
            {if $v.task_name eq 'staff_role'}<li><a href="{$admin_file}?task=staff_role"><i class="fa fa-registered" aria-hidden="true"></i> {if $multiLang.menu_staff_role}{$multiLang.menu_staff_role}{else}No Translate (Key Lang:menu_staff_role){/if}</a></li>{/if}
            {if $v.task_name eq 'staff_permission'}<li><a href="{$admin_file}?task=staff_permission"><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i> {if $multiLang.menu_permission}{$multiLang.menu_permission}{else}No Translate (Key Lang:menu_permission){/if}</a></li>{/if}
            {if $v.task_name eq 'staff_function'}<li><a href="{$admin_file}?task=staff_function"><i class="fa fa-retweet" aria-hidden="true"></i> {if $multiLang.menu_function}{$multiLang.menu_function}{else}No Translate (Key Lang:menu_function){/if}</a></li>{/if}
          {/foreach}
          </ul>
        </li>
        ...
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"><i class="fa fa-users" aria-hidden="true"></i> User <span class="caret"></span></a>
          <ul class="dropdown-menu">
          {foreach from=$staffPermission item=v}
            {if $v.task_name eq 'psychologist'}<li><a href="{$admin_file}?task=psychologist"><i class="fa fa-user-plus" aria-hidden="true"></i> {if $multiLang.menu_psychologist}{$multiLang.menu_psychologist}{else}No Translate (Key Lang: menu_psychologist){/if}</a></li>{/if}
            {if $v.task_name eq 'patient'}<li><a href="{$admin_file}?task=patient"><i class="fa fa-user-md" aria-hidden="true"></i> {if $multiLang.menu_patient}{$multiLang.menu_patient}{else}No Translate (Key Lang: menu_patient){/if}</a></li>{/if}
          {/foreach}
          </ul>
        </li>
        {foreach from=$staffPermission item=v}
          {if $v.task_name eq 'question'}<li><a href="{$admin_file}?task=question"><i class="fa fa-question-circle" aria-hidden="true"></i> {if $multiLang.menu_question}{$multiLang.menu_question}{else}No Translate (Key Lang: menu_question){/if}</a></li>{/if}
        {/foreach}
        <li class="dropdown" id="test_setting">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"><i class="fa fa-cog" aria-hidden="true"></i> Test Setting <span class="caret"></span></a>
          <ul class="dropdown-menu">
            {foreach from=$staffPermission item=v}
              {if $v.task_name eq 'test'}<li><a href="{$admin_file}?task=test"><i class="fa fa-clone fa-fw"></i> {if $multiLang.menu_test}{$multiLang.menu_test}{else}No Translate (Key Lang: menu_test){/if}</a></li>{/if}
              {if $v.task_name eq 'test_question'}<li><a href="{$admin_file}?task=test_question"><i class="fa fa-clone fa-fw"></i> {if $multiLang.menu_test_question}{$multiLang.menu_test_question}{else}No Translate (Key Lang: menu_test_question){/if}</a></li>{/if}
              {if $v.task_name eq 'test_group'}<li><a href="{$admin_file}?task=test_group"><i class="fa fa-clone fa-fw"></i> {if $multiLang.menu_test_group}{$multiLang.menu_test_group}{else}No Translate (Key Lang: menu_test_group){/if}</a></li>{/if}
            {/foreach}
          </ul>
        </li>
        ...
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"><i class="fa fa-share-square-o" aria-hidden="true"></i> Test Assign <span class="caret"></span></a>
          <ul class="dropdown-menu">
            {foreach from=$staffPermission item=v}
              {if $v.task_name eq 'test_psychologist'}<li><a href="{$admin_file}?task=test_psychologist"><i class="fa fa-user-plus" aria-hidden="true"></i> {if $multiLang.menu_psychologist}{$multiLang.menu_psychologist}{else}No Translate (Key Lang: menu_psychologist){/if}</a></li>{/if}
              {if $v.task_name eq 'test_patient'}<li><a href="{$admin_file}?task=test_patient"><i class="fa fa-user-md" aria-hidden="true"></i> {if $multiLang.menu_patient}{$multiLang.menu_patient}{else}No Translate (Key Lang: menu_patient){/if}</a></li>{/if}
            {/foreach}
          </ul>
        </li>
      </ul>
