        ...
        <div class="row">
              ...
              <div class="form-group">
                ...
                <div class="form-group" style="margin-bottom:5px;">
                  <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                    <i class="fa fa-plus-circle"></i> Add Staff Role
                  </button>
                </div>
                &nbsp;&nbsp;&nbsp;
                <div class="form-group" style="margin-bottom:5px;">
          ...
          <div class="col-md-12">
            <div class="collapse {if $error Or $edit.id}in{/if}" id="collapseExample" style="margin-top: 10px;">
              {if $error OR $edit.id}
              <form class="form" role="form" action="{$admin_file_name}?task=staff_role&amp;action=edit&amp;id={$edit.id}" method="post">
                {else}
                <form class="form" role="form" action="{$admin_file_name}?task=staff_role&amp;action=add" method="post">
                  {/if}
                  <div class="form-group" style="margin-bottom:5px;">
