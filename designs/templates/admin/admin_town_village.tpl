  ...
  <div class="panel-body">
    <div class="panel panel-default">
      <div class="panel-body">
        <div class="row">
          <div class="col-sm-12">
            <form class="form-inline" action="{$admin_file}?task=town_village" method="get">
          ...
          <div class="col-md-12">
            <div class="collapse {if $error Or $getVillageByID.id}in{/if}" id="collapseExample" style="margin-top: 10px;">
              ...
              <form class="form" role="form" action="{$admin_file}?task=town_village&amp;action=edit&amp;id=$getVillageByID.id" method="post">
                {else}
                <form class="form" role="form" action="{$admin_file}?task=town_village&amp;action=add" method="post">
                  {/if}
                  ...
                  <div class="form-group" style="margin-bottom:5px;">
                    ...
                    <a href="{$admin_file}?task=town_village" class="btn btn-danger"><i class="fa fa-close"></i>  {if $multiLang.button_cancel}{$multiLang.button_cancel}{else}No Translate (Key Lang:button_cancel){/if}</a>
                  </div>
                  {else}
                  <div class="form-group" style="margin-bottom:5px;">
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              <td>{$data.name}</td>
              <td>
                <a href="{$admin_file}?task=town_village&amp;action=edit&amp;id={$data.id}" class="btn btn-success btn-xs" data-toggle1="tooltip" data-placement="top" title="{if $multiLang.button_edit}{$multiLang.button_edit}{else}No Translate (Key Lang:button_edit){/if}"><i class="fa fa-edit"></i></a>
                  ...
                  <div class="modal-dialog">
                    ...
                    <div class="panel panel-primary modal-content">
                      ...
                      <div class="modal-footer">
                        <a href="{$admin_file}?task=town_village&amp;action=delete&amp;id={$data.id}" class="btn btn-danger btn-md" style="color: white;"><i class="fa fa-trash-o"> {if $multiLang.button_yes}{$multiLang.button_yes}{else}No Translate (Key Lang:button_yes){/if}</i></a>
