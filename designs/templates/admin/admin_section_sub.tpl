        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="{$admin_file}?task=section_sub&amp;tid={$smarty.get.tid}&amp;par_id={$data.id}" class="btn btn-info btn-xs" data-toggle1="tooltip" data-placement="top" title="Add Section Sub"><i class="fa fa-plus-circle"></i></a>
