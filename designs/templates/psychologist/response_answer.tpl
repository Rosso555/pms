...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    <div class="box_title">
      <b>{if $reponseById.pat_name}Patient:{else}Psychologist:{/if}</b>  {if $reponseById.pat_name}{$reponseById.pat_name}{else}{$reponseById.first_name} {$reponseById.last_name}{/if} /
      <b>{if $multiLang.text_test_title}{$multiLang.text_test_title}{else}No Translate(Key Lang: text_test_title){/if}:</b> {$reponseById.test_title}
    </div>
