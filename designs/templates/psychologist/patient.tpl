            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  {if $error.name}<span style="color:red">Please enter name!</span>{/if}
                  <input type="text" class="form-control" id="name" placeholder="Enter name" name="name" value="{if $editPatient.name}{$editPatient.name}{else}{$smarty.session.patient.name}{/if}">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
