...
<div class="inbox-test sansserif" style="margin-bottom: 20px; padding: 60px 15px 60px 15px; text-align: center; font-size: 20px; color: #a94442;">
  ...
  <p>All questionnaires are filled it and are now analyzed by your psychologist.</p>
  <br>
  <a href="{$psychologist_file}" class="btn btn-primary"><i class="fa fa-fw fa-home"></i> {if $multiLang.button_home}{$multiLang.button_home}{else}No Translate (Key Lang: button_home){/if}</a>
</div>
