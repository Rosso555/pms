...
define("IMAGE_FILES_PATH", "/home/pms.e-khmer.com/images/");
$allows   =   array(
  ...
  'TYPE'  =>  array(
        ...
        'audio' =>  array('audio/mpeg', 'audio/mp3', 'audio/ogg', 'audio/wav', 'audio/aac', 'audio/webm'),
        'document'  =>  array('text/plain', 'application/pdf', 'application/msword', 'application/xml', 'application/zip', 'application/x-rar-compressed')
  )
);
